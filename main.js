...
class Interface {
  ...
  deleteProduct(element_HTML) {
    if (element_HTML.name === "delete") {
      //si el elemento capturado tiene la priedad (name) "delete", este caso en nuestro enlace (etiqueta "a")
  ...
  showMeessage(message, cssClass) {
    //va a mostrar un mensaje en la interfaz
...
//capturar el evento para borrar elementos (productos) en la lista
document
